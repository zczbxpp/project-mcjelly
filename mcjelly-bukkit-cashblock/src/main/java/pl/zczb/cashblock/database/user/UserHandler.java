...
package pl.zczb.cashblock.database.user;
...
public class UserHandler {
    ...
    public UserHandler(Cashblock plugin, MongoDatabase database) {
...
//        }
    ...
    public UserDataModel createUser(Player player) {
        ...
        UserDataModel dataModel = new UserDataModel(uuid.toString(), player.getName(), 0.0D, 0, "", 0L, false, UserPets.createDefault(), UserLvl.createDefault(), UserHomes.createDefault(), false, 0, false, UserPrestiz.createDefault());
